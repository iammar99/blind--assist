...
def upload_image(request):
    if request.method == 'POST':
        ...
        # its means there is not voice interaction?
        # No the output is something he stored for test purpose which is in both text and audio but when you will give the response of the model he will add that.
            # Process the image (e.g., save it)
            image.save('uploaded_image.jpg')#E:\Python\Django\blind-assist\blindAssist\uploaded_image.jpg
            #print(image)
            mainCode('uploaded_image.jpg') # is this image replace by new one? yes
